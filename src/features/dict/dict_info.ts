...
// 国际考试
const internationalExam: DictInfo[] = [
  {
    id: 'gmat',
    name: 'GMAT',
    description: 'GMAT 词库',
...
// 青少儿英语
const childrenEnglish: DictInfo[] = [
  {
    id: 'gaokao3500',
    name: '高考 3500 词',
...
const dictionaryResources: DictInfo[] = []
dictionaryResources.push(...chinaExam)
dictionaryResources.push(...internationalExam)
dictionaryResources.push(...childrenEnglish)
// dictionaryResources.push(...programming)
// dictionaryResources.push(...japaneseExam)
// dictionaryResources.push(...germanExam)

export { dictionaryResources }
